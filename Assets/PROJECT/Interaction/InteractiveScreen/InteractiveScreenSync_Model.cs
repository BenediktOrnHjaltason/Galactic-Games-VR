...
public partial class InteractiveScreenSync_Model : RealtimeModel {
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        if (context.fullModel) {
            ...
            LocalCacheEntry entry = _cache.localCache;
            if (entry.executingAnythingSet || entry.executingMinMaxSet || entry.executingSlideChangeSet || entry.activeSlideIndexSet || entry.previousSlideIndexSet || entry.slideChangedSet) {
