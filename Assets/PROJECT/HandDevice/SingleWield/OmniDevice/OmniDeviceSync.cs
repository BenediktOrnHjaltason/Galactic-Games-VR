...
{
    MeshRenderer details1;
    MeshRenderer details2;
    ...
    protected override void Awake()
    {
        ...
        details1 = transform.GetChild(8).GetComponent<MeshRenderer>();
        details2 = transform.GetChild(9).GetComponent<MeshRenderer>();
