...
[RealtimeModel]
public partial class HandDeviceSync_Model
{
...
public partial class HandDeviceSync_Model : RealtimeModel {
    ...
    public bool visible {
        get {
            return _cache.LookForValueInCache(_visible, entry => entry.visibleSet, entry => entry.visible);
        }
        set {
            if (this.visible == value) return;
            _cache.UpdateLocalCache(entry => { entry.visibleSet = true; entry.visible = value; return entry; });
            InvalidateReliableLength();
            FireVisibleDidChange(value);
        }
    }
    
    public delegate void PropertyChangedHandler<in T>(HandDeviceSync_Model model, T value);
    ...
    public event PropertyChangedHandler<bool> visibleDidChange;
    ...
    public HandDeviceSync_Model() : this(null) {
    }
    
    public HandDeviceSync_Model(RealtimeModel parent) : base(null, parent) {
    }
    ...
    private void FireVisibleDidChange(bool value) {
        try {
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        if (context.fullModel) {
            ...
            length += WriteStream.WriteVarint32Length((uint)PropertyID.Visible, _visible ? 1u : 0u);
            ...
            if (entry.visibleSet) {
                length += WriteStream.WriteVarint32Length((uint)PropertyID.Visible, entry.visible ? 1u : 0u);
            }
        }
        return length;
    }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        if (context.fullModel) {
            ...
            stream.WriteVarint32((uint)PropertyID.Visible, _visible ? 1u : 0u);
        } else if (context.unreliableChannel) {
            if (_controlledStructurePositionShouldWrite) {
                _controlledStructurePositionShouldWrite = false;
                stream.WriteBytes((uint)PropertyID.ControlledStructurePosition, WriteStream.Vector3ToBytes(_controlledStructurePosition));
            ...
            LocalCacheEntry entry = _cache.localCache;
            if (entry.deviceModeSet || entry.operationStateSet || entry.visibleSet) {
            ...
            if (entry.visibleSet) {
                stream.WriteVarint32((uint)PropertyID.Visible, entry.visible ? 1u : 0u);
                didWriteProperties = true;
            }
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            switch (propertyID) {
                ...
                case (uint)PropertyID.Visible: {
                    bool previousValue = _visible;
                    _visible = (stream.ReadVarint32() != 0);
                    bool visibleExistsInChangeCache = _cache.ValueExistsInCache(entry => entry.visibleSet);
                    if (!visibleExistsInChangeCache && _visible != previousValue) {
                        FireVisibleDidChange(_visible);
                    }
                    break;
                }
                default: {
