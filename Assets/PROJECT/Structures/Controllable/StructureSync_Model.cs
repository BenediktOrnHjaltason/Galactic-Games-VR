...
public partial class StructureSync_Model
{
    ...
    float _sideGlowOpacity = 0.2f;

}

/* ----- Begin Normal Autogenerated Code ----- */
public partial class StructureSync_Model : RealtimeModel {
    public float sideGlowOpacity {
        get {
            return _sideGlowOpacity;
        }
        set {
            if (_sideGlowOpacity == value) return;
            _sideGlowOpacityShouldWrite = true;
            _sideGlowOpacity = value;
    ...
    private bool _sideGlowOpacityShouldWrite;
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        if (context.fullModel) {
            FlattenCache();
            length += WriteStream.WriteFloatLength((uint)PropertyID.SideGlowOpacity);
            ...
            if (_sideGlowOpacityShouldWrite) {
                length += WriteStream.WriteFloatLength((uint)PropertyID.SideGlowOpacity);
            }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        if (context.fullModel) {
            stream.WriteFloat((uint)PropertyID.SideGlowOpacity, _sideGlowOpacity);
            _sideGlowOpacityShouldWrite = false;
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            switch (propertyID) {
                ...
                case (uint)PropertyID.SideGlowOpacity: {
                    _sideGlowOpacity = stream.ReadFloat();
                    _sideGlowOpacityShouldWrite = false;
                    break;
                }
                default: {
